...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;"></label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;"><strong></strong></label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Action: Hover your mouse over “A technician may enter, but I want to be present”</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Action: Hover your mouse over “I am not granting entry at this time”</label></li>
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: The button is outlined in blue and the box turns gray</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: The circle is filled in with blue and more options appear</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: The box is outlined in orange and your cursor is inside.</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: The words are in the box</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: The box is blank and back to its original look </label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: The box is highlighted in orange and your cursor is in the box</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: The box is empty and back to it’s original look</label></li>
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Action: Click the square next to “Dog on Property?”</label></li>
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: The square is filled in orange with a checkmark and additional words appear below</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: The Dog on Property option is deselected and goes back to its original state</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Action: Click on the text box below “Availability/Access Notes (optional)”</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: The words are now in the box</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Action: Click the square next to the words “I would like to request a scheduled visit”</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: “Alain Delon” is now in the box (and in my heart)</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: “1911911991” is now in the box</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: The box should already be filled in</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: The box is now unselected and white</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: Compare what you see with the following screenshot. Ensure everything matches</label></li>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: The page should look like this: </label></li>
</ul>
...
<li><label style="cursor:pointer;display:flex;align-items:flex-start;gap:8px;"><input type="checkbox" style="margin-top:3px;accent-color:#22c55e;flex-shrink:0;">Result: You get a screen that looks like the following<strong></strong></label></li>
</ul>
